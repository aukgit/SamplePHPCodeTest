...
var app = {
 ...
 function updateOutput() {
 	...
 	$("iframe").contents().find("html").html("<html><head><style type='text/css' rel='stylesheet'>" + app.Csseditor.getValue() + "</style></head><body>" + app.Htmleditor.getValue() + "</body></html>");
 ...
 $("textarea").on('change keyup paste keydown', function(e) {
	...
	let html = app.Htmleditor.getValue();
	let css = app.Csseditor.getValue();
	let js = app.Jseditor.getValue();
    ...
    $.ajax({
      ...
      dataType: "html",
      data: {codename:codenames, html: gethtml, css: getcss, js: getjs }
		})
			.done(function( msg ) {
